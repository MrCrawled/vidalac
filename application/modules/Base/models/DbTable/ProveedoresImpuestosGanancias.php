...
class Base_Model_DbTable_ProveedoresImpuestosGanancias extends Base_Model_DbTable_PersonasImpuestosGanancias
{
    ...
    protected $_referenceMap = array(
        ...
        'TiposDeImpuestosGananciasRetenciones' => array(
            'columns'            => 'TipoRetencionGanancia',
            'refTableClass'      => 'Base_Model_DbTable_TiposDeImpuestosGananciasRetenciones',
            'refJoinColumns'     => array("Codigo", "Descripcion"),
            'comboBox'           => true,
            'comboSource'        => 'datagateway/combolist',
            'refTable'           => 'TiposDeImpuestosGananciasRetenciones',
            'refColumns'         => 'Id',
            'comboPageSize' => 10
        ),
    );
